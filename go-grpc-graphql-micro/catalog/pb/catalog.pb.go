...
type GetProductsRequest struct {
	...
	Take          uint64                 `protobuf:"varint,2,opt,name=limit,proto3" json:"limit,omitempty"`
...
const file_catalog_proto_rawDesc = "" +
	...
	"\aproduct\x18\x01 \x01(\v2\v.pb.ProductR\aproduct\"f\n" +
	...
	"\vPostProduct\x12\x16.pb.PostProductRequest\x1a\x17.pb.PostProductResponseB8Z6github.com/tanyaP0405/go-grpc-graphql-micro/catalog/pbb\x06proto3"
...
var file_catalog_proto_depIdxs = []int32{
	...
	4, // 5: pb.CatalogService.PostProduct:input_type -> pb.PostProductRequest
	2, // 6: pb.CatalogService.GetProduct:output_type -> pb.GetProductResponse
	6, // 7: pb.CatalogService.GetProducts:output_type -> pb.GetProductsResponse
	5, // 8: pb.CatalogService.PostProduct:output_type -> pb.PostProductResponse
