...
const file_account_proto_rawDesc = "" +
	...
	"\vGetAccounts\x12\x16.pb.GetAccountsRequest\x1a\x17.pb.GetAccountsResponseB8Z6github.com/tanyaP0405/go-grpc-graphql-micro/account/pbb\x06proto3"
...
var file_account_proto_depIdxs = []int32{
	...
	1, // 2: pb.AccountService.PostAccount:input_type -> pb.PostAccountRequest
	3, // 3: pb.AccountService.GetAccount:input_type -> pb.GetAccountRequest
	5, // 4: pb.AccountService.GetAccounts:input_type -> pb.GetAccountsRequest
	2, // 5: pb.AccountService.PostAccount:output_type -> pb.PostAccountResponse
	4, // 6: pb.AccountService.GetAccount:output_type -> pb.GetAccountResponse
	6, // 7: pb.AccountService.GetAccounts:output_type -> pb.GetAccountsResponse
